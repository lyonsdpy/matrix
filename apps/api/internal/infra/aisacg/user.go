...
func NewUserManager(client *Client, logger *zap.Logger) UserManager {
...
func (m *userManager) GetUser(ctx context.Context, name string) (*User, error) {
...
func (m *userManager) CreateUser(ctx context.Context, req *UserUpdate) (*UserUpdate, error) {
...
func (m *userManager) UpdateUser(ctx context.Context, name string, req *UserUpdate) (*UserUpdate, error) {
...
func unmarshalUserUpdate(data json.RawMessage) (*UserUpdate, error) {
	// 尝试数组格式
	var items []UserUpdate
